...
internal class Metadata : IWritableMetadata, IReadableMetadata
{
    ...
    public IWritableMetadata SetDateTimeValue(string key, DateTime value) { bag.SetDateTimeValue(key, value); return this; }
