...
public class ManualDrainJobsRunner : DrainJobsRunnerBase, IDrainSavePendingJobsRunner
{
    ...
    public override async Task<OnTickResult> OnTickAsync(CancellationToken ct)
    {
        ...
        var savingPendingJobs = await agentJobsDispatcherService
            .DequeueSavePendingJobsAsync(BackgroundAgentWorker.AgentConnectionId, BucketId.NotNull(), BackgroundAgentWorker.BatchSize);
