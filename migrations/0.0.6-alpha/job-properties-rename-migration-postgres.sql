...
ALTER TABLE [your-prefix]job ADD COLUMN next_plan_execution_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE [your-prefix]job RENAME COLUMN original_scheduled_at TO scheduled_at_temp;
