...
{
    internal override string ClusterId { get; set; } = RepoConformanceBootstrap.MySqlClusterId;
    ...
    public override async Task InitializeAsync()
    {
        ...
        var agentConfig = JobMasterClusterConnectionConfig
            ...
            .TryGetAgentConnectionConfig(RepoConformanceBootstrap.MySqlAgentConnectionName);

        if (agentConfig == null)
        {
            throw new Exception($"Agent config '{RepoConformanceBootstrap.MySqlAgentConnectionName}' not found for cluster '{ClusterId}'.");
        }
        ...
        AgentConnectionId = new AgentConnectionId(ClusterId, RepoConformanceBootstrap.MySqlAgentConnectionName);
    }
}
