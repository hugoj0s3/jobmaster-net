...
/// connection (sqlserver-agent-1/2/3), pooled alongside drainer-1/2/3 which keep running in the background
...
/// under load.
/// </summary>
public sealed class SqlServerDistPhase3Emulator(ScenarioGlobalEnvironment global, ScenarioRunner runner)
    : BasePhaseEmulator<SqlServerDistPhases>(global, runner)
{
    ...
    public override SqlServerDistPhases Phase() => SqlServerDistPhases.Phase3;
