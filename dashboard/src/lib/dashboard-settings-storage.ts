...
export class SettingsStorage {
    static readonly Dashboards = {
        resolve(clusterId: string | null | undefined): DashboardSettings {
        ...
        set(clusterId: string, settings: DashboardSettings) {
