...
/// workers, each on the *same* agent connection its dead counterpart used (drainer-1/raven-agent-1,
/// drainer-2/raven-agent-2, drainer-3/raven-agent-3) -- AssignedLostBucketsRunner reassigns a dead
...
/// </summary>
public sealed class RavenDbDistPhase2Emulator(ScenarioGlobalEnvironment global, ScenarioRunner runner)
    : BasePhaseEmulator<RavenDbDistPhases>(global, runner)
{
    ...
    public override RavenDbDistPhases Phase() => RavenDbDistPhases.Phase2;
