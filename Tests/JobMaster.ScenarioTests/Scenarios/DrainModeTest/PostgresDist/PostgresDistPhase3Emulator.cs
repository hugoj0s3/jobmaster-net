...
/// connection (pg-agent-1/2/3), pooled alongside drainer-1/2/3 which keep running in the background
...
/// under load.
/// </summary>
public sealed class PostgresDistPhase3Emulator(ScenarioGlobalEnvironment global, ScenarioRunner runner)
    : BasePhaseEmulator<PostgresDistPhases>(global, runner)
{
    ...
    public override PostgresDistPhases Phase() => PostgresDistPhases.Phase3;
