...
/// connection (mysql-agent-1/2/3), pooled alongside drainer-1/2/3 which keep running in the background
...
/// under load.
/// </summary>
public sealed class MySqlDistPhase3Emulator(ScenarioGlobalEnvironment global, ScenarioRunner runner)
    : BasePhaseEmulator<MySqlDistPhases>(global, runner)
{
    ...
    // turns), not a regression. One PostgresDist run only got 3072/3500 "fast" jobs done in 15
    // minutes.
    ...
    public override MySqlDistPhases Phase() => MySqlDistPhases.Phase3;
