...
/// </summary>
public sealed record ScheduleRequest(string? ClusterId, int QtyJobs, int? AfterSeconds, string TestIdentifier, int? Priority = null, bool? InjectFailure = null, int? MaxNumberOfRetries = null);
