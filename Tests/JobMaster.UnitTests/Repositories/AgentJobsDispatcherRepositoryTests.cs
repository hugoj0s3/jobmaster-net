...
public class AgentJobsDispatcherRepositoryTests
{
    ...
    private sealed class FakeRawRepo : IAgentRawMessagesDispatcherRepository
    {
        ...
        public Task<IList<JobMasterRawMessage>> DispatchMessagesAsync(string fullBucketAddressId, int numberOfJobs, DateTime? referenceTimeTo = null) => Task.FromResult<IList<JobMasterRawMessage>>(new List<JobMasterRawMessage>());
