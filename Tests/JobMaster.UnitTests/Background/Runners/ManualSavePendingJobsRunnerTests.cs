...
/// <summary>
/// Unit tests for <see cref="ManualSavePendingJobsRunner"/>.
...
/// </summary>
public class ManualSavePendingJobsRunnerTests
{
    // ── helpers ────────────────────────────────────────────────────────────────
    ...
    /// </summary>
    private static ManualSavePendingJobsRunner CreateRunner(
        RunnerFixture f, string? bucketId = TestBucketId)
    {
        var runner = new ManualSavePendingJobsRunner(f.Worker.Object);
        if (bucketId != null)
    ...
    public async Task OnTickAsync_WhenBucketIdNotDefined_ShouldReturnSkipped()
    {
        ...
        var runner = new ManualSavePendingJobsRunner(f.Worker.Object); // no DefineBucketId
