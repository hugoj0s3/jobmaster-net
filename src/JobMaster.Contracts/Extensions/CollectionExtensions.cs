...
internal static class CollectionExtensions
{
    ...
    internal static void AddRange<T>(this ICollection<T> list, ICollection<T> items)
    {
        if (list is List<T>)
        {
    ...
    internal static void RemoveAll<T>(this ICollection<T> list, Func<T, bool> predicate)
    {
    ...
    internal static T? Random<T>(this ICollection<T> list)
    {
