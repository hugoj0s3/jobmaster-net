...
[Collection("MixedScheduler")]
public class MixedSchedulerTests : JobMasterSchedulerTestsBase<MixedSchedulerFixture>
{
    public MixedSchedulerTests(MixedSchedulerFixture fixture, ITestOutputHelper output) : base(fixture, output) { }
