...
public interface IJwtBearerAuthConfigSelector
{
    ...
    IJwtBearerAuthConfigSelector RegisterJwtBearerAuthProvider<T>() where T : class, IJobMasterJwtBearerAuthProvider;
    ...
    IJwtBearerAuthConfigSelector RegisterDefaultJwtBearerAuthProvider(TokenValidationParameters parameters);
    ...
    IJwtBearerAuthConfigSelector AuthorizationHeaderName(string headerName);
    ...
    IJwtBearerAuthConfigSelector Scheme(string scheme);
}
